  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="login-form">
        <h3 style={{"color" : "Green"}}> Todo application<br/> Login </h3>
        <div>
        ...
        <div>
          ...
          <input type="password" name="password" id="password" onChange={handleChange} value={password} placeholder='Enter your email'/>
        </div>
